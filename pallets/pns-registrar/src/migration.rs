...
impl<T: registry::Config> Initialize<T> {
    pub fn initial_registry(official: T::AccountId, root_domain: DomainHash) -> Weight {
        ...
        <T as polkadot_sdk::frame_system::Config>::DbWeight::get().writes(6)
    }
}
...
impl<T: origin::Config> Initialize<T> {
    pub fn initial_origin(managers: Vec<T::AccountId>) -> Weight {
        ...
        <T as polkadot_sdk::frame_system::Config>::DbWeight::get().writes(w)
    }
}

type BalanceOf<T> = <<T as price_oracle::Config>::Currency as polkadot_sdk::frame_support::traits::Currency<
...
impl<T: price_oracle::Config> Initialize<T> {
    ...
    pub fn initial_price_oracle(
        ...
        <T as polkadot_sdk::frame_system::Config>::DbWeight::get().writes(3)
    }
}
